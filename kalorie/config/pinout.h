...
#define N_USED_ADDR DDRC
#define N_USED_NR PC6
...
Pin(Pin::Addr(N_USED_ADDR, N_USED_ADDR, N_USED_ADDR), N_USED_NR, true), // 7 //FIXME! (& 4 below) nie alokowac tego -> dodac id
Pin(Pin::Addr(N_USED_ADDR, N_USED_ADDR, N_USED_ADDR), N_USED_NR, true), // 8 //FIXME! 
...
Pin(Pin::Addr(N_USED_ADDR, N_USED_ADDR, N_USED_ADDR), N_USED_NR, true), // 20 //FIXME! 
Pin(Pin::Addr(N_USED_ADDR, N_USED_ADDR, N_USED_ADDR), N_USED_NR, true), // 21 //FIXME!
Pin(Pin::Addr(N_USED_ADDR, N_USED_ADDR, N_USED_ADDR), N_USED_NR, true), // 22 //FIXME!
